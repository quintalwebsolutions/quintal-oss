import type { BodyCellOutputFromPlugins, BodyOutputFromPlugins, BodyRowOutputFromPlugins, HeadCellOutputFromPlugins, HeadOutputFromPlugins, HeadRowOutputFromPlugins, Plugins, TableOutputFromPlugins } from './plugins';
...
export type BodyCell<TRow extends Row, TPlugins extends Plugins, TValue> = BodyCellBase<TRow, TValue> & BodyCellOutputFromPlugins<TPlugins>;
...
export type BodyRow<TRow extends Row, TPlugins extends Plugins> = BodyRowBase<TRow, TPlugins> & BodyRowOutputFromPlugins<TPlugins>;
...
export type Body<TRow extends Row, TPlugins extends Plugins> = BodyBase<TRow, TPlugins> & BodyOutputFromPlugins<TPlugins>;
...
export type HeadRow<TPlugins extends Plugins> = HeadRowBase<TPlugins> & HeadRowOutputFromPlugins<TPlugins>;
...
export type Table<TRow extends Row, TPlugins extends Plugins> = TableBase<TRow, TPlugins> & TableOutputFromPlugins<TPlugins>;
