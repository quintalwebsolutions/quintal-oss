...
-|-|-
[`@quintal/config`](https://github.com/quintalwebsolutions/quintal-oss/tree/main/packages/config)|[![npm version](https://img.shields.io/npm/v/@quintal/config.svg?style=flat-square)](https://www.npmjs.com/package/@quintal/config)|Type-safe configuration file management with sensible defaults for your favourite tools.
